...
<html>
	...
	<body>
		<FORM name="formulaire" METHOD="POST" action="RechargerCompte_Admin_Verif.php" style ="margin-left:5px;">
			...
			<tr>
			<td style="font-size:18px;">
				<br><b>Solde &agrave; ajouter:</b><input placeholder="Solde" type="text" 
				style="margin-left:20px;margin-right:5%" size=20 name="SoldeAjout" value="" required></br>
			</td>
			</tr>
			<td style="font-size:18px;">
